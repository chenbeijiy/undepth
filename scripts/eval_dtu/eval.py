...
if __name__ == '__main__':
    ...
    obs_mask_file = loadmat(f'{args.dataset_dir}/Points/ObsMask/ObsMask{args.scan}_10.mat')
    ...
    ground_plane = loadmat(f'{args.dataset_dir}/Points/ObsMask/Plane{args.scan}.mat')['P']
